...
public class AppBackApplication implements CommandLineRunner
{
	...
	{
		studentRepository.saveAndFlush(new Student(1,"Carlos","Garcia","dam06.2020@gmail.com", new Date(2021,4,27), "Logroño", 40, "BackEnd","Activo"));
		studentRepository.saveAndFlush(new Student(2,"Manuel","Perez","dam12.2020@gmail.com", new Date(2021,4,27), "Logroño", 40, "BackEnd","Activo"));
		studentRepository.saveAndFlush(new Student(3,"Marta","Fernandez","dam2.2020@gmail.com", new Date(2021,4,28), "Logroño", 40, "FrontEnd","Activo"));
		studentRepository.saveAndFlush(new Student(4,"Luis","Ruiz","dam8.2020@gmail.com", new Date(2021,4,29), "Logroño", 40, "BacktEnd","Activo"));
